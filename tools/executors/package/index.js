...
function normalizeOptions(opts, context) {
    ...
    return __assign(__assign({}, opts), { fileReplacements: [], assets: __spreadArrays(((_a = opts.assets) !== null && _a !== void 0 ? _a : []), [opts.actionPath]), root: path_1.resolve(context.root), projectRoot: projectRoot, sourceRoot: path_1.resolve(projectRoot, 'src'), tsConfig: path_1.resolve(projectRoot, 'tsconfig.lib.ts'), main: path_1.resolve(opts.main), outputPath: path_1.resolve(opts.outputPath) });
}
...
function runNccCommand(opts) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            processExitListener = function () { return pack.kill(); };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, __await(assets_1.copyAssetFiles(assets_1.assetGlobsToFiles(opts.assets, opts.root, opts.outputPath)))];
                case 2:
                    _a.sent();
